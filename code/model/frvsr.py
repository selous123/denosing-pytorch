...
class FRVSR(nn.Module):
    ...
    def forward(self, input):
        ...
        # print(self.EstLrImg)
        relative_placeNCHW = func.interpolate(relative_place, scale_factor=4, mode="bilinear", align_corners=False)
...
class TestFRVSR(unittest.TestCase):
    ...
    def testFRVSR(self):
        ...
        block.init_hidden(torch.device( "cpu"))
